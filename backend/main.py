                ...
                async for line in response.aiter_lines():
                    if line.startswith("data: "):
                        ...
                        try:
                            ...
                            # Skip JSON parsing errors for malformed intermediate chunks
                            pass
        except Exception as e:
            logger.error(f"Exception during AI completions streaming: {e}")
            yield f"\n[Backend Error: Failed to communicate with provider: {str(e)}]"
